...
class Line {
  ...
  set(direction) {
    ...
    this.#oppositeDirection = direction.getOposite();
  }
...
class Turn {
  ...
  reset() {
    for (let i = 0; i < Turn.#NUMBERS_PLAYERS; i++) {
  ...
  play() {
    ...
    if (!this.#board.isFinished()) {
      this.#activePlayer = (this.#activePlayer + 1) % Turn.#NUMBERS_PLAYERS;
    }
  }
